<template>
  <div class="user-info-page">
    <group label-width="4.5em" label-margin-right="2em" label-align="right">
      <x-input title="姓名" placeholder="请输入姓名" v-model="userInfo.name"></x-input>
...
<script>
import { GroupTitle, Group, XInput, Selector, Box,
   PopupPicker, Datetime, ChinaAddressData , XButton} from 'vux'
export default {
  components: {
    GroupTitle,Group,XInput,Selector,PopupPicker,Datetime,ChinaAddressData,XButton,
    Box
  },
  data () {
    return {
